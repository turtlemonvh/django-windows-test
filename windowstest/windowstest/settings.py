# Django settings for windowstest project.
...
SECRET_KEY = 'hsh$4*cu499^9e4!xh9=4qlpaw6d8u_-jvq0qz#$6)92!q2xwu'
...
ROOT_URLCONF = 'windowstest.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'windowstest.wsgi.application'
